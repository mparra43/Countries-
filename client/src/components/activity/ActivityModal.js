...
export const ActivityModal = () => {
    ...
    const handleSubmitForm = (e) => {
        ...
        closeModal();
        alert("Agregaste una nueva actividad")
    }
        ...
        >
            ...
            >
                ...
                <div className="select">
                    ...
                    <small id="emailHelp" className="form-text text-muted">temporada del año para realizar la
                        actividad</small>
                </div>
                ...
                <div className="select">
                    ...
                    <select
                        ...
                        value={country}
                        onChange={handleInputChange}
                    >{allCountries.data.map((e) => <option key={e.id}>{e.name}</option>)}
                    </select>
